...
class StatisticMethodsTestCase(unittest.TestCase):
    """
    test of the statistique method, return a float
    """

    def setUp(self):
        self.mark_list = [2, 4, 6, 7, 10, 12, 13, 15, 16, 18, 19, 20]
        self.mark_list_odd = [2, 4, 6, 7, 10, 13, 15, 16, 18, 19, 20]


    def test_Moyenne(self):
        """
        check that the Moyenne function return the mean value with the float type
        """
        """
        there is a probleme with the type of the return
        """
        obtained = statistic.Moyenne(self.mark_list)
        # print(obtained)
        expected = 11.83
        # print(expected)
        # print(obtained - expected)
        self.assertEqual(type(obtained),type(expected))
        self.assertEqual(obtained,expected)

    def test_Note_Plus_Basse(self):
        """
        check that the function return the minimum value of a list
        """
        obtained = statistic.Note_plus_basse(self.mark_list)
        expected = 2
        self.assertEqual(obtained, expected)

    def test_Note_Plus_Haute(self):
        """
        check that the function return the maximum value of a list
        """
        obtained = statistic.Note_plus_haute(self.mark_list)
        expected = 20
        self.assertEqual(obtained, expected)


    # not the real way to calculate quartile no ?

    def test_Q1(self):
        """
        check that the function return the first quartile of a marks list
        with a odd and even number of marks in the list
        """
        obtained = statistic.Q1(self.mark_list)
        expected = 6
        obtained_odd = statistic.Q1(self.mark_list_odd)
        expected_odd = 6

        self.assertEqual(obtained, expected)
        self.assertEqual(obtained_odd, expected_odd)

    def test_Q3(self):
        """
        check that the function return the third quartile of a marks list
        with a odd and even number of marks in the list
        """
        obtained = statistic.Q3(self.mark_list)
        expected = 16
        obtained_odd = statistic.Q3(self.mark_list_odd)
        expected_odd = 18
    ...
    # the the median is fine

    def test_Median(self):
        """
        check that the function return the median value of a marks list
        with a odd and even number of marks in the list
        """
        obtained = statistic.Mediane(self.mark_list)
        expected = 12.5
        obtained_odd = statistic.Mediane(self.mark_list_odd)
        expected_odd = 13
